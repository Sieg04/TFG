...
import { BaseChartDirective } from 'ng2-charts'; // Importación correcta en ng2-charts v6
...
@Component({
  ...
  imports: [CommonModule, BaseChartDirective], // Actualizado el nombre del módulo
